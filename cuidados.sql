...
BEGIN TRY
	...
	begin
		...
		SELECT 409 AS codeStatus, 'El tipo de cuidado ya �xiste.' AS messageStatus
     ...
     VALUES
		   ...
		   SELECT 200 AS codeStatus, 'El tipo cuidado por planta ha sido creado con �xito.' AS messageStatus
...
BEGIN TRAN
	...
	END ELSE BEGIN
		   ...
		   SELECT 200 AS codeStatus, 'El tipo cuidado por planta ha sido editado con �xito.' AS messageStatus
 ...
 BEGIN TRAN
	...
	UPDATE  [bota].[tbTiposCuidados]
	  ...
	  WHERE ticu_Id = @ticu_Id
		...
		SELECT 200 AS codeStatus, 'El tipo cuidado ha sido eliminado con �xito.' AS messageStatus
