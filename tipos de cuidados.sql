...
UPDATE [bota].[tbCuidadoPlanta]
  ...
  WHERE  cupl_Id = @cupl_Id
			...
			SELECT 200 AS codeStatus, 'El cuidado por planta ha sido editado con �xito.' AS messageStatus
COMMIT
...
UPDATE [bota].[tbCuidadoPlanta]
  ...
  WHERE  cupl_Id = @cupl_Id
 			...
 			SELECT 200 AS codeStatus, 'El Cuidado ha sido eliminado con �xito.' AS messageStatus
